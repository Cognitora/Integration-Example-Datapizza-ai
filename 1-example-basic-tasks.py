"""
Datapizza AI + Cognitora Sandbox Integration Example
=====================================================

This example demonstrates how to create an AI agent that can execute code
in a secure sandbox environment using datapizza-ai and Cognitora SDK.
...
def main():
    ...
    agent = Agent(
        name="TaskExecutor",
        client=client,
        system_prompt="""You are a helpful AI assistant that executes code to solve problems.
...
NOT just: 5 + 5""",
    ...
    print("=" * 80)
    print("🍕 Datapizza AI + 🔒 Cognitora: Real-Life Task Automation")
    print("=" * 80)
    print()
...
Write JavaScript code. console.log() all results with labels."""
    ...
    print()
    response7 = agent.run(query7)
    print(f"✅ Result: {response7}")
    print()
...
Write Bash commands. Echo all results with labels."""
    ...
    print()
    response8 = agent.run(query8)
    print(f"✅ Result: {response8}")
    print()
