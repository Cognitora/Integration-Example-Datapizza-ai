...
def main():
    ...
    print(f"   • Datapizza AI - Agentic analysis orchestration")
    ...
    stock_analyst = Agent(
        name="stock_analyst",
        client=client,
        system_prompt="""You are an expert Financial Analyst and Data Scientist specializing in stock market analysis.
...
Include specific predictions and percentages!"""
    ...
    for i, analysis in enumerate(analyses, 1):
        ...
        result = stock_analyst.run(analysis['query'])
    ...
    print(f"{Colors.BLUE}💡 Inspired by Dynamiq's autonomous analyst{Colors.ENDC}")
    print(f"{Colors.DIM}   But built with Datapizza AI + Cognitora!{Colors.ENDC}\n")
