...
Always execute code and show the output!"""
    ...
    print("╔════════════════════════════════════════════════════════════════════════════════╗")
    print("║                                                                                ║")
    print("║      🍕  D A T A P I Z Z A   A I   +   🔒  C O G N I T O R A                  ║")
    print("║                                                                                ║")
    ...
    print(f"   {Colors.BOLD}Datapizza AI{Colors.ENDC} - Advanced agent framework with tool integration")
    ...
    while True:
        try:
            ...
            # Get response from agent with system instruction
